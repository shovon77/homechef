...
export default function MagicLogin() {
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'center', padding:16, gap:12}}>
      <Text style={{color:'#FE73FC', fontSize:22, fontWeight:'900'}}>Login via Email Link</Text>
      {sent ? (
        <>
          <Text style={{color:'#FE73FC', textAlign:'center'}}>
        ...
        <>
          <TextInput
            ...
            style={{width:320, backgroundColor:'#0f172a', color:'#FE73FC', padding:10, borderRadius:8, borderWidth:1, borderColor:'#1f2937'}}
          />
          ...
          <Text style={{color:'#FE73FC', fontSize:12, textAlign:'center', maxWidth:360}}>
