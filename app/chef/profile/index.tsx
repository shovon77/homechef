  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: theme.colors.surface }} contentContainerStyle={{ padding: 20 }}>
      <View style={{ maxWidth: 600, width: "100%", alignSelf: "center" }}>
        <Text style={{ fontSize: 28, fontWeight: "900", color: theme.colors.text, marginBottom: 24 }}>Chef Profile</Text>
        ...
        >
          ...
          <View style={{ alignItems: "center" }}>
            <View style={{ backgroundColor: "rgba(34, 197, 94, 0.2)", paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 }}>
              <Text style={{ color: "#22c55e", fontWeight: "900", fontSize: 14 }}>Chef</Text>
            </View>
          </View>
