  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.title}>CUSTOMER TERMS OF SERVICE & FOOD SAFETY DISCLOSURE</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>3. Food Safety Disclosure (Critical)</Text>
          <Text style={styles.paragraph}>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>6. Payments, Fees & Refunds</Text>
          <Text style={styles.paragraph}>
          ...
          <View style={styles.list}>
            <Text style={styles.listItem}>• Platform service fees</Text>
            <Text style={styles.listItem}>• Convenience or processing fees</Text>
          </View>
          <Text style={styles.paragraph}>
          ...
          <View style={styles.list}>
            ...
            <Text style={styles.listItem}>• No safety issue is demonstrated</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.heading}>11. Privacy, Data Collection & Cookies</Text>
