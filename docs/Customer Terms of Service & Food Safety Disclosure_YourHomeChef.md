# CUSTOMER TERMS OF SERVICE & FOOD SAFETY DISCLOSURE
...
* Ingredient sourcing  
* Allergen disclosure  
* Compliance with applicable food safety laws

1.4 The Platform’s role is limited to facilitating listings, orders, payments, and pickup coordination.
...
* Inspecting packaging upon pickup  
* Proper food handling and storage after pickup

2.4 The Platform is not responsible for delays, missed pickups, or food conditions after the pickup window.

# 3\. Food Safety Disclosure (Critical)

3.1 Food is prepared by independent Chefs, not the Platform.  
3.2 The Platform does not independently inspect certifications, documentation, kitchens, or preparation practices. All food safety, preparation, and handling responsibilities remain with the Chef.  
...
* Customers assume these risks when ordering

# 4\. Allergens & Dietary Information
...
4.3 Customers with allergies or dietary restrictions must contact the Chef directly before ordering or refrain from ordering.  
4.4 The Platform is not responsible for allergic reactions or dietary incompatibility.

# 5\. Health Concerns & Incident Reporting
...
* Temporarily suspend a Chef at its discretion for complaints or reported incidents  
* Issue refunds or credits at its discretion  
* Customers are encouraged to contact local Public Health authorities directly if necessary.  
* The Platform is not responsible for reporting on behalf of customers.

5.4 Refunds do not constitute an admission of fault or liability.

# 6\. Payments, Fees & Refunds

6.1 Payments are processed through a third-party payment processor. The payments are subject to the processor’s own terms and privacy practices.  
6.2 The Platform may charge:

* Platform service fees  
* Convenience or processing fees

6.3 Refunds are handled case by case and are not guaranteed, especially where:

* Pickup windows are missed  
* No safety issue is demonstrated

# 7\. Platform Limitations & Disclaimer
...
* Non-interruption or error-free service

7.3 The Platform does not guarantee:

* Food quality consistency  
* Availability of specific Chefs or menu items  
...
* Foodborne illness  
* Allergic reactions  
* Injuries arising from food consumption  
* Acts or omissions of Chefs
...
* Review ingredient and allergen disclosures carefully  
* Follow safe food-handling practices after pickup  
* Use the Platform lawfully and respectfully

# 10\. Suspension & Account Termination
...
# 11\. Privacy, Data Collection & Cookies
...
Updated Terms will be made available on the Platform, and the “Last Updated” date will be revised accordingly. Continued access to or use of the Platform after such changes constitutes acceptance of the revised Terms. acceptance.  
