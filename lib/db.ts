...
const DISH_DETAIL_SELECT =
  'id, name, chef, chef_id, price, category, image, description, portion, ingredients, thumbnail, featured, created_at, is_active, rating, chefs ( id, name, slug, photo, email, user_id )';
